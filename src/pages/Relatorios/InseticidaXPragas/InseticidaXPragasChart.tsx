...
const generateMockData = (
  ...
  return dateRange.map((date) => {
    let baseInseticidaXPragas: number;

    switch (rangeType) {
      case "day":
        baseInseticidaXPragas = Math.floor(Math.random() * 6);
        break;
      case "month":
        baseInseticidaXPragas = Math.floor(Math.random() * 41) + 10;
        break;
      case "year":
        baseInseticidaXPragas = Math.floor(Math.random() * 401) + 100;
        break;
      default:
        baseInseticidaXPragas = 0;
    }

    const variation =
      Math.random() > 0.7
        ? Math.floor(Math.random() * baseInseticidaXPragas * 0.5)
        : 0;
    const inseticidaXPragas = baseInseticidaXPragas + variation;
