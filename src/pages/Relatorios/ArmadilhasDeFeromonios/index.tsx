...
export const RelatorioArmadilhasDeFeromonios = () => {
  // hooks
  ...
  // variables
  const paginatedArmadilhasDeFeromonios = filteredArmadilhasDeFeromonios.slice(
    page * rowsPerPage,
  ...
  return (
    <Loading {...{ loading, setLoading }}>
      <Layout title="Armadilhas de Feromônios">
        <FormProvider {...methods}>
          <Box sx={{ width: "100%" }}>
            <Grid container spacing={3}>
              ...
              <Grid size={{ xs: 12 }}>
                <ArmadilhasDeFeromoniosChart />
              </Grid>

              <Grid size={{ xs: 12 }}>
                <TableArmadilhasDeFeromonios
                  {...{
                    paginatedList: paginatedArmadilhasDeFeromonios,
                    filteredList: filteredArmadilhasDeFeromonios,
                    rowsPerPage,
                    page,
                    handleChangePage,
